...
(function () {
  ...
  var LEAD_ENDPOINT = 'https://script.google.com/macros/s/AKfycbxQG3TMCyR9iN0-I6Qc9b14nim9HijDoJgk1uXTgMfNBlJMjh8qNBp4qAyYFC0YHJJUlQ/exec';
  ...
  /* Чем кончается отправка: 'pay' — страница оплаты, 'channel' — закрытый
     канал, 'team' — ничем: заявку разбирает команда и пишет человеку сама.
  ...
  submit.addEventListener('click', function () {
    ...
    function goToPayment() {
      /* Уходить некуда: человек остаётся на странице, а дальше с ним
         связывается команда. Показываем это прямо в форме. */
      if (IS_TEAM) {
        hide(errBox);
        show(sentBox);
