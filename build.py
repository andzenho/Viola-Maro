...
def build_landing():
    ...
    if IS_ZAYAVKA:
        ...
        for old, new in (
            ...
            ("Ответим в&nbsp;Telegram, поможем оформить оплату или рассрочку.",
             "Команда Виолы напишет вам в&nbsp;Telegram: расскажет, как устроен "
             "практикум, ответит на&nbsp;вопросы и&nbsp;поможет провести оплату "
             "безопасно&nbsp;— целиком или в&nbsp;рассрочку."),
            ("Готово. Мы получили заявку и&nbsp;напишем вам в&nbsp;Telegram.",
             "Заявка у&nbsp;нас. Команда Виолы напишет вам в&nbsp;Telegram "
             "и&nbsp;доведёт до&nbsp;оплаты вместе с&nbsp;вами."),
        ):
            if old not in form:
    ...
    if MODE == "zayavka":
        ...
        tpl = tpl.replace(
            "В «С Виолой» пятьдесят мест. Оплатить можно сразу или частями&nbsp;— "
            "рассрочка до&nbsp;12&nbsp;месяцев для&nbsp;СНГ.",
            "В «С Виолой» пятьдесят мест. Оставьте заявку&nbsp;— команда напишет "
            "в&nbsp;Telegram, ответит на&nbsp;вопросы и&nbsp;поможет оплатить безопасно.")
